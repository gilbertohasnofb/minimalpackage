...
print('# functions')
print()
print(f'minimalpackage.function1(): {minimalpackage.function1()}')
print(f'minimalpackage.function2(): {minimalpackage.function2()}')
print()
...
print('# classes')
print()
print('c1 = minimalpackage.Class1()')
print('c2 = minimalpackage.Class2()')
print()
